            ...
            <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link link text-white display-4" ><span class="mbri-cash mbr-iconfont mbr-iconfont-btn"></span>Current Wallet: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</a>
                ...
                <div class="row justify-content-md-center">
                    <div class="col-md-10 align-center">
                        ...
                        <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1">
                            ...
                            <% }%>
                        <p class="mbr-text pb-3 mbr-fonts-style display-5">Perform Administrative Duties Below</p>
        ...
        <section class="services6 cid-rnOnfBSE9i" id="services6-8">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <jsp:include page="editMovie.jsp" flush="true" />
